              ...
              <div className="flex justify-start flex-col">
                ...
                >
                  <p className="mt-2 leading-relaxed text-sm text-gray-700 dark:text-white/70">
                    ...
                    online presence, and our goal is to help bussinesses
                    establish a strong digital presence. Our process begin with
                    understanding your needs and goals, and then we work closely
                    with you.
                  </p>
                </Fade>
